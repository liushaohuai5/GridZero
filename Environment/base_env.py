...
class Environment:
    def __init__(self, settings, reward_type="EPRIReward", is_test=False, two_player=False, attack_all=False):
    ...
    def step_only_attack(self, act):
        ...
        disc_name, self.steps_to_reconnect_line, self.count_soft_overflow_steps = self.disconnect.get_disc_name(
            last_obs, attack=act, attack_all=self.attack_all, two_player=self.two_player)
